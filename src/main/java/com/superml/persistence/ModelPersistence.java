    ...
    public static void saveWithStats(BaseEstimator model, String filePath, String description,
        ...
        try {
            ...
            if (XTest != null && yTest != null) {
                ...
                if (model instanceof com.superml.core.SupervisedLearner) {
                    com.superml.core.SupervisedLearner supervisor = (com.superml.core.SupervisedLearner) model;
                    ...
                    if (isClassification) {
                        ...
                        autoMetadata.put("test_accuracy", com.superml.metrics.Metrics.accuracy(yTest, predictions));
                        ...
                        if (uniqueClasses.size() == 2) {
                            autoMetadata.put("test_precision", com.superml.metrics.Metrics.precision(yTest, predictions));
                            autoMetadata.put("test_recall", com.superml.metrics.Metrics.recall(yTest, predictions));
                            autoMetadata.put("test_f1_score", com.superml.metrics.Metrics.f1Score(yTest, predictions));
                        }
                        autoMetadata.put("unique_classes", uniqueClasses.size());
                    } else {
                        autoMetadata.put("task_type", "regression");
                        autoMetadata.put("test_mse", com.superml.metrics.Metrics.meanSquaredError(yTest, predictions));
                        autoMetadata.put("test_mae", com.superml.metrics.Metrics.meanAbsoluteError(yTest, predictions));
                        autoMetadata.put("test_r2", com.superml.metrics.Metrics.r2Score(yTest, predictions));
                    }
